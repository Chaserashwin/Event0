  ...
  return (
    <>
      <div className="w-full border-t border-gray-500 sm:mb-10 sm:mt-20 mt-10 mb-10 ">
        <div className="w-full h-auto flex flex-wrap flex-col md:p-10 max-w-10xl mx-auto px-4 sm:px-6 justify-center">
...
export default NewlyAddedEvents;
